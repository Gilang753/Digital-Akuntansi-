...
public class GUI_Otomotif extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Table_Otm.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nama Dealer", "Alamat Dealer", "Merek", "Model", "Tahun", "Harga"
            }
        ));
    ...
    private void btn_cetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_cetakActionPerformed
       try {
        ...
        String model = otm.model;
        list.add(otm.cetak(model));
        int tahun = otm.tahun;
        list.add(otm.cetak(tahun));
        ...
        // Exception handling untuk NumberFormatException (misalnya, jika parsing teks ke integer gagal)
        JOptionPane.showMessageDialog(null, "Masukkan tahun dengan format angka yang valid.", "Error", JOptionPane.ERROR_MESSAGE);
        // Anda dapat menambahkan tindakan tambahan sesuai kebutuhan, seperti membersihkan input atau menampilkan pesan kesalahan tambahan.
    } catch (HeadlessException e) {
        // Exception handling umum untuk menangani kesalahan lainnya
