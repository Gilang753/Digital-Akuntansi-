...
public class GUI_GajiReward extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        gr.gajipokok = Double.parseDouble(txt_gaji.getText());
        gr.anak = Double.parseDouble(txt_anak.getText());
        gr.menit = Integer.parseInt(txt_lembur.getText());
        txt_bonus.setText(Double.toString(gr.tunjanganAnak()+gr.lembur()));
