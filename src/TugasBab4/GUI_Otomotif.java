...
public class GUI_Otomotif extends javax.swing.JFrame {
    ...
    private void btn_cetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_cetakActionPerformed
        ...
        Otomotif oto = new Otomotif();
        oto.merek = txt_merek.getText();
        oto.model = txt_model.getText();
        oto.tahun = txt_tahun.getText();
        String hargaKendaraan = (txt_harga.getText());
        oto.aturHarga(hargaKendaraan);
        
        txtArea_hasil.append("Informasi Otomotif\n");
        txtArea_hasil.append("----------------------------\n");
        txtArea_hasil.append("Merek : "+oto.cetakMerek()+"\n");
        txtArea_hasil.append("Model : "+oto.cetakModel()+"\n");
        txtArea_hasil.append("Tahun : "+oto.cetakTahun()+"\n");
        txtArea_hasil.append("Harga : "+oto.dapatkanHarga()+"\n");
